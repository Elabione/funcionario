...
namespace apifuncionario.Controllers
{
    ...
    public class SetorController : ControllerBase
    {
        ...
        // GET: api/Setor
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Setor>>> GetCategorias()
        {
        ...
        public async Task<ActionResult<Setor>> GetSetor(int id)
        {
          if (_context.Categorias == null)
          {
            ...
            var setor = await _context.Categorias.FindAsync(id);
        ...
        public async Task<IActionResult> DeleteSetor(int id)
        {
            ...
            _context.Categorias.Remove(setor);
            await _context.SaveChangesAsync();
        ...
        {
            return (_context.Categorias?.Any(e => e.SetorID == id)).GetValueOrDefault();
        }
    }
}
